      ...
      <el-table-column prop="date" label="" :show-overflow-tooltip="true">
        <template #default="scope">
          ...
          <template v-if="scope.row.type == 3">
            <img :src="scope.row.instanceInfo.picture" class="image_show" />
    ...
    <el-dialog width="30%" title="信息编辑" v-model="gimmickFormVisible">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button :disabled="gimmickSaving" :loading="gimmickSaving" type="primary" @click="gimmickFormSave">保 存</el-button>
        </span>
      </template>
    </el-dialog>
